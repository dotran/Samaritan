/*
 * cnsga2.c:
 *  This file implements the main procedures of NSGA-II with constraint handling. It is based on the following reference:
 *
...
void CNSGA2 (population_real* parent_pop, population_real* offspring_pop, population_real* mixed_pop)
{
    ...
    while (evaluation_count < max_evaluation)
    {
        ...
        fill_constraint_nondominated_sort (parent_pop, mixed_pop);
